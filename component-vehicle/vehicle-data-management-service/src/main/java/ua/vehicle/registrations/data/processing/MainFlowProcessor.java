package ua.vehicle.registrations.data.processing;
...
import ua.vehicle.registrations.data.processing.tasks.*;
...
public class MainFlowProcessor {
    ...
    public void processRegistrationData(URL dataPassportJsonUrl) {
        ...
        parsedDataArchiveURLs.forEach(archiveUrl -> {
            ...
            log.info("Start time: {}, End time: {}, diff: {}", timeBefore, timeAfter,
                    ChronoUnit.SECONDS.between(timeBefore, timeAfter)
            );
