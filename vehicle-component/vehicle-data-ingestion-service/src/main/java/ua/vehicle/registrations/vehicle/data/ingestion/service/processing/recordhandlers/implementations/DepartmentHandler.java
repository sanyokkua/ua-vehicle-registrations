...
@Component
@Slf4j
public class DepartmentHandler extends RegistrationBaseHandler<Department> {

    @Autowired
    public DepartmentHandler(RawSqlRepository<Department> repository, BaseCsvVehicleRegistrationRecordMapper<Department> mapper) {
